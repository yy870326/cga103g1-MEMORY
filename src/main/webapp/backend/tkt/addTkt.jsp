...
<body>
	...
	<div class="content-body">
		...
		<c:if test="${not empty errorMsgs}">
			...
			<div class="col-12">
				<form action="<%=request.getContextPath()%>/tkt/addTkt.do"
					method="post" class="modal-content" enctype="multipart/form-data">
					<div class="modal-header">
						<h3 class="modal-title">新增票券</h3>
					</div>
					<div class="modal-body">
						...
						<div class="form-row d-flex input-mb">
							...
							<div class="form-group col-md-3">
								<label class="form-label" for="kind">票券種類</label></br> 
								<select
					...
					<div class="modal-footer">
						<!-- hidden input -->
						<input type="hidden" name="action" value="tktAdd"> <a
							href="<%=request.getContextPath()%>/backend/tkt/listAllTkt.jsp"
