...
.modal-body .payment-title {
	width: 100%;
	text-align: center;
}

.modal-body .form-container .field-container:first-of-type {
	grid-area: name;
}

.modal-body .form-container .field-container:nth-of-type(2) {
	grid-area: number;
}

.modal-body .form-container .field-container:nth-of-type(3) {
	grid-area: expiration;
}

.modal-body .form-container .field-container:nth-of-type(4) {
	grid-area: security;
}
...
.modal-body #ccsingle svg {
	width: 100px;
	max-height: 60px;
}

.modal-body .creditcard svg#cardfront, .creditcard svg#cardback {
	width: 100%;
...
.modal-body .creditcard .lightcolor, .creditcard .darkcolor {
	-webkit-transition: fill .5s;
	transition: fill .5s;
}

.modal-body .creditcard .lightblue {
	fill: #03A9F4;
}

.modal-body .creditcard .lightbluedark {
	fill: #0288D1;
}

.modal-body .creditcard .red {
	fill: #ef5350;
}
...
.modal-body .creditcard .purpledark {
	fill: #7b1fa2;
}

.modal-body .creditcard .cyan {
	fill: #26c6da;
}

.modal-body .creditcard .cyandark {
	fill: #0097a7;
}

.modal-body .creditcard .green {
	fill: #66bb6a;
}

.modal-body .creditcard .greendark {
	fill: #388e3c;
}

.modal-body .creditcard .lime {
	fill: #d4e157;
}

.modal-body creditcard .limedark {
	fill: #afb42b;
}

.modal-body .creditcard .yellow {
	fill: #ffeb3b;
}

.modal-body .creditcard .yellowdark {
	fill: #f9a825;
}

.modal-body .creditcard .orange {
	fill: #ff9800;
}

.modal-body .creditcard .orangedark {
	fill: #ef6c00;
}

.modal-body .creditcard .grey {
	fill: #bdbdbd;
}

.modal-body .creditcard .greydark {
	fill: #616161;
}
...
.modal-body .creditcard .front, .creditcard .back {
	position: absolute;
	width: 100%;
	max-width: 400px;
...
.modal-body .creditcard .back {
	-webkit-transform: rotateY(180deg);
	transform: rotateY(180deg);
}

.modal-body .creditcard.flipped {
	-webkit-transform: rotateY(180deg);
	transform: rotateY(180deg);
}
</style>
		...
		<div class="col-sm-12 mt-5 mb-5">
			<div class="d-flex justify-content-between mb-5">
				...
				<button type="button" class="btn btn-primary" data-toggle="modal"
					data-target="#exampleModalCenter">新增信用卡</button>
			</div>


			<div class="table-responsive-sm">
				<table
					class="table table-lg table-bordered table-striped text-center">
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLongTitle">新增信用卡</h5>
						...
						<div class="form-container">
							...
							<div class="field-container">
								<label for="cardnumber">Card Number</label><span
									id="generatecard">generate random</span> <input id="cardnumber"
	...
	<script>
		window.onload = function() {
					...
					cardnumber,
					{
						...
						dispatch : function(appended, dynamicMasked) {
							...
							for (var i = 0; i < dynamicMasked.compiledMasks.length; i++) {
								let re = new RegExp(
										dynamicMasked.compiledMasks[i].regex);
			...
			const swapColor = function(basecolor) {
				document.querySelectorAll('.lightcolor').forEach(
						function(input) {
							input.setAttribute('class', '');
							input.setAttribute('class', 'lightcolor '
									+ basecolor);
						});
				document.querySelectorAll('.darkcolor').forEach(
						function(input) {
							input.setAttribute('class', '');
							input.setAttribute('class', 'darkcolor '
									+ basecolor + 'dark');
						});
			};
			...
			const randomCard = function() {
				let testCards = [ '4000056655665556', '5200828282828210',
						'371449635398431', '6011000990139424',
						'30569309025904', '3566002020360505',
			...
			name.addEventListener('focus', function() {
				document.querySelector('.creditcard').classList
						.remove('flipped');
			});
