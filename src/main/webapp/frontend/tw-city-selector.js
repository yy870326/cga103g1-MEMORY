    ...
    return function(t) {
                ...
                function() {
                    ...
                    if (function() {
                            ...
                            for (var e = function() {
                                ...
                                }.call(this), o = 0, s = n.counties.length; o < s; o++)
                                if (!(e && -1 === e.indexOf(n.counties[o]) || i && -1 !== i.indexOf(n.counties[o]))) {
        ...
        function c() {
            ...
            for (var i = function(t) {
                ...
                }.call(this, this.elCounty.value), s = 0, l = n.districts[t][0].length - 1; s <= l; s++)
                if (!(i && -1 === i.indexOf(n.districts[t][0][s]) || o && -1 !== o.indexOf(n.districts[t][0][s]))) {
