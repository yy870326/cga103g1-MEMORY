  ...
  <%-- 錯誤表列 --%>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 Filter-left mb-60">
				<form class="col-lg-12 col-md-12 col-sm-12 d-flex row" method="post" action="<%=request.getContextPath()%>/RmRsv/RmRsv.do" id="getEnoughType">
					
					<div class="col-lg-4 col-md-3 col-sm-12">
					 <label for="form_dates" class="form-label">透過關鍵字查詢</label>
       	 <div class="form-group">
           <input class="form-control" type="text" placeholder="請搜尋關鍵字" name="add">
       	  </div>
       </div>
...
<!--           <input class="form-control" type="text"  id="rangeDate"  name="rangedate"  placeholder="Check-in"  /> -->
        <label for="check_in" class="form-label">入住時間</label>
          <input class="form-control" type="text"  id="datepicker"  name="arrival_date" autocomplete="off"  placeholder="Check-in"/>
          </div>
       <div class="col-lg-3 col-md-3 col-sm-12">
        <label for="check_out" class="form-label">退房時間</label>
            <input class="form-control"  type="text" id="datepicker-out"  name="departure_date" autocomplete="off"   placeholder="Check-out"/>
         </div>
         <div class="col-lg-3 col-md-3 col-sm-12">
        <label for="peoplet" class="form-label">入住人數</label>
		...
		<div class="col-lg-3 col-md-3 col-sm-12">
        <label for="peoplet" class="form-label">預定房間數量</label> 
        <select id="roomtotal" name="roomtotal" class="form-control" required>
		...
		<option value="6" ${roomtotal == 6 ? 'selected' : '' }>6間</option>
			...
			<button type="submit" class="btn btn-primary btn-grad FilterBtn1" onclick="check();"> <i class="fas fa-filter mr-1"></i>查詢 </button>
       </div>
					...
					<div class="room-content">
						<div class="section-title text-center">
							...
							<h3 class="room-subtitle text-left ">
								每週挑選網友票選最佳民宿，讓您能在眾多民宿中找到最適合您的住宿方案
							</h3>
						</div>
						<a href="<%=request.getContextPath()%>/frontend/room/rmList.jsp" class="more-btn btn-bg" >更多精選房型</a>
					</div>
				</div>

				<div class="col-lg-5">
					<div class="room-img">
						<img src="<%=request.getContextPath()%>/frontend/assets/images/hotels/no-img.jpeg">
					</div>
				</div>
			</div>
		</div>
