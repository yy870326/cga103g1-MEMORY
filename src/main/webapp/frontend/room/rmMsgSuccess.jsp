...
<head>
  <meta charset="utf-8" />
    ...
    <title>美陌旅</title>
		...
		<meta http-equiv="refresh" content="3;url=<%=request.getContextPath()%>/frontend/homePage.jsp">
	<style>
		*{
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="login-box">
                            <div class="login-top">
                                <h3>您的建議已送出 我們會盡快為您處理</h3>
                                <p><a href="<%=request.getContextPath()%>/frontend/homePage.jsp">請按此回頁面</a></p>
                            </div>
