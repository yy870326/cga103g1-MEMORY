						...
						<div class="col-xl-8">
							<div class="row mb-2">
							    ...
							    <select class="form-control" name="store_no" >
									...
									<c:forEach var="storeVO" items="${storeSvc.allStore}">
										<option value="${storeVO.store_no}"
											${(rmTypeVO.store_no==storeVO.store_no)?'selected':''}>${storeVO.store_name}</option>
									</c:forEach>
								</select>
<%-- 							    	<input type="text" name="rm_type_name" maxlength="10" class="form-control" id="rm_type_name" value="<%=(rmTypeVO == null) ? "" : rmTypeVO.getRm_name()%>"> --%>
							    </div>
							    </div>
							<div class="row mb-2">
							    <label for="rm_name" class="col-sm-3 col-form-label">房型名稱</label>
							    <div class="col-sm-8">
							    	<input type="text" name="rm_name" maxlength="10" class="form-control" id="rm_name" value="${rmTypeVO.rm_name}">
							    </div>
							</div>
								<div class="row mb-2">
							    <label for="rm_people" class="col-sm-3 col-form-label">每房可住人數</label>
							    <div class="col-sm-8">
							...
							<div class="row mb-2">
							    <label for="rm_area" class="col-sm-3 col-form-label">房型大小</label>
							    <div class="col-sm-8">
							    	<input type="text" name="rm_area" class="form-control" id="rm_area" value="${rmTypeVO.rm_area}">
							    </div>
							</div>
							<div class="row mb-2">
							    <label for="rm_intro" class="col-sm-3 col-form-label">房型資訊</label>
							    <div class="col-sm-8">
							    	<textarea name="rm_intro" rows="4" class="form-control" id="rm_intro" value="${rmTypeVO.rm_intro}"></textarea>
							    </div>
							</div>
						</div>
					</div>
