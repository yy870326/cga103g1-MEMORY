...
@WebServlet(name = "TktItemServlet", urlPatterns = { "/tkt_order/tktItem.do" })
public class TktItemServlet extends HttpServlet {
...
//		System.out.println(tktItemList.size());
		...
		RequestDispatcher successView = req.getRequestDispatcher("/frontend/tkt_order/tktItem.jsp");
